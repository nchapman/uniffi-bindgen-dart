...
pub(super) fn async_rust_future_spec(
    ...
    match return_type.map(runtime_unwrapped_type) {
        ...
        Some(type_) if is_runtime_optional_record_type(type_) => Some(AsyncRustFutureSpec {
            suffix: "string",
            complete_native_type: "ffi.Pointer<Utf8>",
            complete_dart_type: "ffi.Pointer<Utf8>",
        }),
        Some(type_) if is_runtime_optional_enum_type(type_) => Some(AsyncRustFutureSpec {
            suffix: "string",
            complete_native_type: "ffi.Pointer<Utf8>",
            complete_dart_type: "ffi.Pointer<Utf8>",
        }),
